    ...
    <div class="container-fluid mt-4">
        ...
        <?php if (isset($error_message)): ?>
            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                ...
                <br><br>
                <a href="<?php echo app_url('company.php'); ?>" class="btn btn-primary">Back to Company List</a>
                <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
            </div>
        <?php endif; ?>
                ...
                <div class="view-header">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="<?php echo app_url('generate_declaration_pdf.php'); ?>?id=<?php echo $declaration_data['declaration_id']; ?>" class="btn btn-outline-success" target="_blank">
                                <i class="fas fa-file-pdf"></i> Generate Declaration PDF
                            </a>
                            <?php endif; ?>
                            <a href="<?php echo app_url('generate_surveillance_pdf.php'); ?>?id=<?php echo $surveillance_id; ?>" class="btn btn-outline-info" target="_blank">
