...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action']) && $_POST['action'] == 'delete_surveillance') {
    ...
    if ($surveillance_id_to_delete > 0) {
        try {
            ...
            header('Location: ' . app_url('surveillance_list.php?' . http_build_query($_GET)));
            exit();
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <nav aria-label="breadcrumb" class="mb-2">
                            <ol class="breadcrumb breadcrumb-custom mb-0">
                                ...
                                <?php if ($patient_id > 0 && isset($patient)): ?>
                                    <li class="breadcrumb-item"><a href="<?php echo app_url('medical_list.php'); ?>?company_id=<?php echo $company_id; ?>"><?php echo htmlspecialchars($company['company_name']); ?></a></li>
                        ...
                        <div class="btn-group">
                            <?php if ($show_all): ?>
                                <a href="<?php echo app_url('surveillance_list.php'); ?>?company_id=<?php echo $company_id; ?><?php echo $patient_id > 0 ? '&patient_id=' . $patient_id : ''; ?>" class="btn btn-outline-secondary">
                                    <i class="fas fa-filter"></i> Filter by Company
                                </a>
                           
                            <?php endif; ?>
                            <?php if ($patient_id > 0): ?>
                                <a href="<?php echo app_url('usechh_1.php'); ?>?patient_id=<?php echo $patient_id; ?>&new_surveillance=1" class="btn btn-primary">
                                                ...
                                                <tr data-patient-id="<?php echo htmlspecialchars(strtolower($report['patient_code'] ?? 'N/A')); ?>"
                                                    ...
                                                    <td style="text-align: center;">
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="<?php echo app_url('usechh1_view.php'); ?>?id=<?php echo $report['surveillance_id']; ?><?php echo !empty($report['declaration_id']) ? '&declaration_id=' . $report['declaration_id'] : ''; ?>" 
                                                               class="btn btn-outline-primary" title="View Details (ID: <?php echo $report['surveillance_id']; ?>)">
                                                                <i class="fas fa-eye"></i>
                                                            </a>
                                                            <a href="<?php echo app_url('surveillance_edit.php'); ?>?id=<?php echo $report['surveillance_id']; ?>" 
