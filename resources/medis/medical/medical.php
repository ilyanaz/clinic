...
// Clear any error messages from previous redirects
if (isset($_SESSION['error_message'])) {
    $error_msg = $_SESSION['error_message'];
    error_log("Medical page: Clearing error message: " . $error_msg);
    unset($_SESSION['error_message']);
}

// Handle form submissions (same as company.php)
if ($_POST) {
...
<head>
    ...
    <title>Medical Management - Medical Surveillance System</title>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0"><i class="fas fa-notes-medical"></i> Medical Management</h5>
                                            ...
                                            <tr data-name="<?php echo strtolower(htmlspecialchars($company['company_name'])); ?>" data-address="<?php echo strtolower(htmlspecialchars($company['address'])); ?>" data-mykpp="<?php echo strtolower(htmlspecialchars($company['mykpp_registration_no'])); ?>">
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="<?php echo app_url('medical_list.php'); ?>?company_id=<?php echo $company['id']; ?>" class="btn btn-outline-primary" title="View List of Patients"><i class="fas fa-clipboard-check"></i></a>
                                                        <a href="<?php echo app_url('company_form.php'); ?>?edit=<?php echo $company['id']; ?>" class="btn btn-outline-warning" title="Edit Company Details"><i class="fas fa-edit"></i></a>
