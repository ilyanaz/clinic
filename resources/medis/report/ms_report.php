            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div>
                            <a href="<?php echo app_url('generate_msReport_pdf.php'); ?>?company_id=<?php echo $company_id; ?>" class="btn btn-primary" target="_blank">
                        ...
                        <div class="col-12">
                            ...
                            <div class="declaration-section mb-4">
                                ...
                                <div class="text-center mt-4 mb-4">
                                    ...
                                    <a href="<?php echo app_url('generate_msReport_pdf.php'); ?>?company_id=<?php echo $company_id; ?>" class="btn btn-primary btn-lg" id="pdfButton" target="_blank" style="display: none;">
