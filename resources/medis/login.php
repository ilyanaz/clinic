...
try {
    ...
    global $clinic_pdo;
    if (!isset($clinic_pdo) && isset($GLOBALS['clinic_pdo'])) {
        $clinic_pdo = $GLOBALS['clinic_pdo'];
    }
    if (!isset($clinic_pdo) || !$clinic_pdo) {
        die("Database connection not available. Please check your database configuration.");
    }
    $stmt = $clinic_pdo->query("SELECT COUNT(*) as count FROM users");
            ...
            <div class="login-body">
                <?php if ($is_logged_in): ?>
                    <div class="alert alert-info" role="alert">
                        <i class="fas fa-info-circle"></i> You are already logged in as <strong><?php echo $_SESSION['username']; ?></strong>
                    </div>
                    ...
                    <div class="text-center">
                        <a href="<?php echo app_url('logout.php'); ?>" class="btn btn-outline-secondary">
