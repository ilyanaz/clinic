...
// Get list of patients for this company
try {
...
if (isset($_GET['debug'])) {
    ...
    echo "<p><strong>Company Name:</strong> '" . $company['company_name'] . "'</p>";
    echo "<p><strong>Patients Count:</strong> " . count($patients) . "</p>";
    echo "<p><strong>Session User ID:</strong> " . $_SESSION['user_id'] . "</p>";
    
    // Debug: Check if there are any patients in occupational_history
    $debug_stmt = $clinic_pdo->prepare("SELECT DISTINCT company_name FROM occupational_history");
    $debug_stmt->execute();
    $companies_in_oh = $debug_stmt->fetchAll(PDO::FETCH_COLUMN);
    echo "<p><strong>Companies in occupational_history:</strong> " . implode(", ", $companies_in_oh) . "</p>";
    
    // Debug: Check if there are any patients at all
    $debug_stmt2 = $clinic_pdo->prepare("SELECT COUNT(*) as total FROM patient_information");
    $debug_stmt2->execute();
    $total_patients = $debug_stmt2->fetch(PDO::FETCH_ASSOC);
    echo "<p><strong>Total patients in database:</strong> " . $total_patients['total'] . "</p>";
    
    // Debug: Show raw query results
    if (!empty($patients)) {
        echo "<h5>Raw Query Results:</h5>";
        echo "<pre>";
        print_r($patients);
        echo "</pre>";
    }
...
<body>
    ...
    <div class="container-fluid mt-4">
        ...
        <div class="mb-4 pb-3 border-bottom">
            <div class="d-flex justify-content-between align-items-start mb-3">
                <a href="<?php echo app_url('company.php'); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <nav aria-label="breadcrumb" class="mb-2">
                            <ol class="breadcrumb breadcrumb-custom mb-0">
                                <li class="breadcrumb-item"><a href="<?php echo app_url('medical.php'); ?>">Company</a></li>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h5 class="mb-0">
                                    <i class="fas fa-users"></i> List of Patients - <?php echo htmlspecialchars($company['company_name']); ?>
                                </h5>
                                <small class="text-muted">Company ID: <?php echo $company_id; ?> | Total: <?php echo count($patients); ?> patients</small>
                            </div>
                            <a href="<?php echo app_url('patient_form.php'); ?>?company=<?php echo urlencode($company['company_name']); ?>" class="btn btn-primary">
                                    ...
                                    <tr data-name="<?php echo strtolower(htmlspecialchars($patient['first_name'] . ' ' . $patient['last_name'])); ?>" 
                                        ...
                                        <td>
                                            <div class="btn-group btn-group-sm">
                                                <a href="<?php echo app_url('surveillance_list.php'); ?>?company_id=<?php echo $company_id; ?>&patient_id=<?php echo $patient['id']; ?>" 
                                                   class="btn btn-outline-info" title="View Surveillance History">
                                                    <i class="fas fa-history"></i>
                                                </a>
                                                <a href="<?php echo app_url('usechh_1.php'); ?>?patient_id=<?php echo $patient['id']; ?>&new_surveillance=1" 
                    ...
                    <?php else: ?>
                        <div class="text-center py-5">
                            ...
                            <a href="<?php echo app_url('patient_form.php'); ?>?company=<?php echo urlencode($company['company_name']); ?>" class="btn btn-outline-primary">
                                <i class="fas fa-plus"></i> Add New Patient
                            </a>
                        </div>
                    <?php endif; ?>
    ...
    <script>
        ...
        function updateResultsCount(count) {
            ...
            if (count === totalCount) {
                resultsText = `Showing all ${totalCount} patients`;
            } else {
                resultsText = `Showing ${count} of ${totalCount} patients`;
            }
            ...
            if (!resultsCounter) {
                ...
                tableContainer.parentNode.insertBefore(resultsCounter, tableContainer);
            }
