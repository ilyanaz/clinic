...
if (!$patient_id) {
    header("Location: " . app_url("patients.php"));
    exit();
}
...
if (isset($patient['error'])) {
    header("Location: " . app_url("patients.php?error=" . urlencode($patient['error'])));
    exit();
}

if (!$patient) {
    header("Location: " . app_url("patients.php?error=" . urlencode("Patient not found")));
    exit();
}
