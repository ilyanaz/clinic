...
$current_page = basename(request()->path(), '.php');
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link <?php echo e($current_page == 'index' ? 'active' : ''); ?>" href="index.php">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo e(in_array($current_page, ['surveillance', 'surveillance_list', 'company', 'patients']) ? 'active' : ''); ?>" href="#" id="medicalSurveillanceDropdown" role="button" data-bs-toggle="dropdown">
                ...
                <!-- Reports Dropdown -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle <?php echo e(in_array($current_page, ['reports', 'medical_report', 'employee_report', 'ms_report', 'abnormal_workers_report']) ? 'active' : ''); ?>" href="#" id="reportsDropdown" role="button" data-bs-toggle="dropdown">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown">
                        <i class="fas fa-user"></i> <?php echo e($user_first_name); ?>
...
<?php /**PATH C:\xampp\htdocs\clinic\resources\views/includes/navigation.blade.php ENDPATH**/ ?>