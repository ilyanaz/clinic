                                            ...
                                            <tr data-name="<?php echo strtolower(htmlspecialchars($company['company_name'])); ?>" 
                                                ...
                                                <td style="text-align: center;">
                                                    <div class="btn-group btn-group-sm">
                                                        <a href="patient_list.php?company_id=<?php echo $company['id']; ?>" class="btn btn-outline-primary" title="View List of Patients">
                                                            <i class="fas fa-clipboard-check"></i>
                                                        </a>
                                                        <a href="company_form.php?edit=<?php echo $company['id']; ?>" class="btn btn-outline-warning" title="Edit Company Details">
