                ...
                <div class="card-body">
                    <form method="GET" class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <a href="/generate_abnormal_pdf.php?company_id=<?php echo $company_id; ?>" class="btn btn-primary" target="_blank">
                ...
                <div class="card-header" style="background: white; border-top: 3px solid #155724; border-left: none; border-right: none; border-bottom: none; border-radius: 8px 8px 0 0;">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <a href="generate_abnormal_pdf.php?company_id=<?php echo $company_id; ?>" class="btn btn-success btn-sm" target="_blank">
