        ...
        <div class="tab-container">
            ...
            <nav aria-label="breadcrumb" class="mb-2" style="padding: 0.5rem 2rem 0.5rem 2rem;">
                <ol class="breadcrumb breadcrumb-custom mb-0">
                    <li class="breadcrumb-item"><a href="medical_list.php">Company</a></li>
                    <?php if (isset($_GET['patient_id']) && $_GET['patient_id'] > 0 && isset($patient) && $company): ?>
                        <li class="breadcrumb-item"><a href="surveillance_list.php?company_id=<?php echo $company_id; ?>"><?php echo htmlspecialchars($company['company_name']); ?></a></li>
                        <li class="breadcrumb-item"><a href="surveillance_list.php?company_id=<?php echo $company_id; ?>&patient_id=<?php echo $_GET['patient_id']; ?>"><?php echo htmlspecialchars($patient['first_name'] . ' ' . $patient['last_name']); ?></a></li>
