                                    ...
                                    <tr data-patient-id="<?php echo htmlspecialchars(strtolower($item['patient']['patient_id'])); ?>"
                                        ...
                                        <td>
                                            <div class="summary-info">
                                                ...
                                                <div class="mt-2">
                                                    <a href="/employee_report.php?patient_id=<?php echo $item['patient']['id']; ?>&patient_name=<?php echo urlencode(ucwords(strtolower($item['patient']['first_name'] . ' ' . $item['patient']['last_name']))); ?>" 
