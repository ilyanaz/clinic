...
if (!$patient_id) {
    header("Location: " . url("patients.php"));
    exit();
}
...
if (isset($patient['error'])) {
    header("Location: " . url("patients.php?error=" . urlencode($patient['error'])));
    exit();
}

if (!$patient) {
    header("Location: " . url("patients.php?error=" . urlencode("Patient not found")));
    exit();
}
