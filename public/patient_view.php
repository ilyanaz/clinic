                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="patients.php" class="btn btn-outline-secondary">
                            ...
                            <a href="generate_patient_pdf.php?id=<?php echo $patient_id; ?>" class="btn btn-success me-2" target="_blank">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            ...
                            <div>
                                <a href="declaration.php?patient_name=<?php echo urlencode($patient['first_name'] . ' ' . $patient['last_name']); ?>&employer=<?php echo urlencode($patient['company_name'] ?? ''); ?>" 
                                   class="btn btn-info me-2" target="_blank">
                                    <i class="fas fa-file-alt"></i> Create Declaration
                                </a>
                                <a href="medical_removal_protection.php?patient_name=<?php echo urlencode($patient['first_name'] . ' ' . $patient['last_name']); ?>&employer=<?php echo urlencode($patient['company_name'] ?? ''); ?>&patient_id=<?php echo $patient['id']; ?>" 
                                   class="btn btn-warning me-2" target="_blank">
                                    <i class="fas fa-shield-alt"></i> Medical Removal Form
                                </a>
                                <a href="patient_form.php?edit=<?php echo $patient['id']; ?>" class="btn btn-warning">
