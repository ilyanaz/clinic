<?php
// Note: Database configuration should be loaded BEFORE this file
// This file contains functions that use $clinic_pdo global variable
...
function getBasePath() {
    ...
    // When served via Laravel routes, calculate base path from REQUEST_URI
    if (isset($_SERVER['REQUEST_URI'])) {
        ...
        // If we're at root level (dirname returns / or \), return empty
    ...
    if (isset($_SERVER['SCRIPT_NAME'])) {
        ...
        // Remove .php extension if present
        $scriptPath = preg_replace('/\.php$/', '', $scriptPath);
        return rtrim($scriptPath, '/') ?: '';
    }
    
    // Default: return empty for root-level routes
    return '';
}
 ...
 * Removes .php extension for cleaner URLs
 */
